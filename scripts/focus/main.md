...
<h2> Содержание:
	* Основа фокусов. Понятие Блока. Список блоков и их назначение
	* Создание дерева фокусов. Привязка дерева к стране.
	* Взаимосвязь между фокусами. Абсолютная и относительная позиция. Предпосылки.
	* Условия. Блок available. Блок allow_branch
	* Примеры фокусов с Относительной и Абсолютной позицией. Примеры взаимоисключающих фокусов. 
	* Области действия. Условные (динамические) области действия.
	* Блок limit. Условный оператор. Блок random_list.
	* Работа с Shared фокусами
	* Работа с непрерывными фокусами
	* 8 советов новичкам, к которым стоит прислушаться
...
<h2>Каков основной синтаксис создания фокусов?</h2> 
...
<h2>Начнем с основы каждого дерева:</h2>
...
Итак, мы создали ветку фокусов. До тех пор, пока в ней ни одного фокуса, в игра вы будете видеть лишь пустую ветку <br>![Вот пустое дерево](./img/emptytree.png)
...
Фокусы бывают двух видов: Стандартные и Shared. Для начала разберемся со стандартными
