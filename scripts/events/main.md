...
Варианты будут расположены один под другим (картинка)
...
А теперь мы по-прежнему будем видеть один вариант ответа, а вот ИИшка - два! (картинка)
...
Синтаксис ивентов такой же, поэтому на них мы останавливаться долго не будем, лишь скажу так: эти ивенты завязаны на on_actions (ссылка на статью), завершениях операций и действиях. Поэтому они выполняются ТОЛЬКО в скоупе оперативника/командующего. 
